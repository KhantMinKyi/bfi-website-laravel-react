import FAQList from '@/components/front-end/admissions/faq/faq-list';
            ...
            >
                ...
                >
                    <div className="relative z-10 flex flex-col items-center justify-center px-4 py-20 text-center md:py-40 lg:py-52">
                        ...
                        <h2 className="font-merriweather mb-4 text-3xl font-bold md:text-5xl">Frequently asked Questions</h2>
                        <p className="mb-6 max-w-2xl text-lg md:text-xl">Our path through innovation, challenge, and achievement.</p>
                    </div>
                </motion.div>
            </div>

            <FAQList faq={faq} isLoading={loading} />
            <ContactBanner />
        </FrontEndLayout>
    );
}
