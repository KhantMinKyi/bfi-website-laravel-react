...
const ContactForm = () => {
    return (
        <>
            <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px] dark:bg-neutral-950">
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                            ...
                            >
                                <div className="mb-12 max-w-[570px] lg:mb-0">
                                    ...
                                    <div className="mb-8 flex w-full max-w-[370px]">
                                        <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-blue-800/5 text-blue-600 sm:h-[70px] sm:max-w-[70px] dark:bg-green-800/5 dark:text-green-600">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <motion.div
                                ...
                                transition={{ duration: 0.5, ease: 'easeInOut' }} // longer duration
                            >
                                <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12 dark:bg-neutral-900">
                                    <form>
                                        ...
                                        <div>
                                            <button
                                                type="submit"
                                                className="hover:bg-opacity-90 w-full cursor-pointer rounded border border-primary bg-primary p-3 text-white transition dark:text-black"
                                            >
                                                Send Message
                                            </button>
                                        </div>
...
type ContactInputBoxType = {
    type: string;
    placeholder: string;
    name: string;
};
const ContactTextArea: React.FC<ContactTextAreaType> = ({ row, placeholder, name, defaultValue }) => {
    return (
        <>
            <div className="mb-6">
                <textarea
...
const ContactInputBox: React.FC<ContactInputBoxType> = ({ type, placeholder, name }) => {
    return (
        <>
            <div className="mb-6">
                <input
