...
type Props = {
    DonationData: CSADataType[];
};
const DonationCardGroup: React.FC<Props> = ({ DonationData }) => {
    return (
        <section className="pt-20 pb-10 lg:pt-[60px] lg:pb-20 dark:bg-gray-950">
            <div className="container mx-auto">
                <div className="flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[710px] text-center">
                            <span className="font-merriweather mb-2 block text-lg font-semibold text-primary">Our </span>
                            <h2 className="text-dark mb-3 text-3xl leading-[1.2] font-bold sm:text-4xl md:text-[40px] dark:text-white">
                                <PullUpHeader text={'Donation'} />
                            </h2>
                ...
                <div className="flex flex-wrap justify-center">
                    {DonationData.map((t, i) => (
                        ...
                        >
                            <DonationCard name={t.title} profession={t.date} imagesrc={t.image} />
                        </motion.div>
                    ))}
                </div>
            </div>
...
export default DonationCardGroup;

const DonationCard: React.FC<TeamCardType> = ({ imagesrc, name, profession }) => {
    return (
        <>
