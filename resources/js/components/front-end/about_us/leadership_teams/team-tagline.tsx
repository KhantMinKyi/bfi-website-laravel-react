            ...
            <div className="container mx-auto grid grid-cols-1 p-10 md:grid-cols-2">
                ...
                >
                    <div className="flex flex-col items-center justify-center">
                        <h2 className="font-merriweather my-10 text-4xl font-bold text-white md:text-6xl">Meet the Senior Executive Team</h2>
                    </div>
                </motion.div>
                <motion.div
                ...
                >
                    <p className="text-white">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste adipisci id, ipsum beatae perspiciatis eum minima placeat
                        praesentium animi eligendi, est nam molestias mollitia eius soluta, necessitatibus quisquam. Officiis, vero!
                    </p>
                </motion.div>
            </div>
        </div>
