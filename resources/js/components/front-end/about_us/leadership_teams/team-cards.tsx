                    ...
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                            ...
                            <h2 className="text-dark mb-3 text-3xl leading-[1.2] font-bold sm:text-4xl md:text-[40px] dark:text-white">
                                <PullUpHeader text={'Leadership Team'} />
                            </h2>
                ...
                <div className="flex flex-wrap justify-center">
                    {teamData.map((t, i) => (
                        <motion.div
                            ...
                            transition={{ duration: i, ease: 'easeInOut' }} // longer duration
                        >
                            <TeamCard name={t.name} profession={t.profession} imagesrc={t.imagesrc} />
                        </motion.div>
                    ))}
                </div>
            </div>
...
const TeamCard: React.FC<TeamCardType> = ({ imagesrc, name, profession }) => {
    return (
        <>
