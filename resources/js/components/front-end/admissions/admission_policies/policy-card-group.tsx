import { policyCardType, TeamCardType } from '@/types';
import { motion } from 'motion/react';
import React from 'react';
type Props = {
    policyCard: policyCardType[];
};
const PolicyCardGroup: React.FC<Props> = ({ policyCard }) => {
    return (
            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-wrap justify-center">
                    {policyCard.map((t, i) => (
                        ...
                        >
                            <PolicyCard name={t.title}  imagesrc={t.src} websiteUrl={t.src} />
                        </motion.div>
                    ))}
                </div>
            </div>
...
const PolicyCard: React.FC<TeamCardType> = ({ imagesrc, name, websiteUrl }) => {
    return (
        <>
