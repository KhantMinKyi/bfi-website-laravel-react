                    ...
                    <div className="grid grid-cols-12 gap-x-4 ">
                        <div className="col-span-12 sm:col-span-6 md:col-span-4 col:col-span-12 my-auto py-10 pl-4">
                            <div
                                ...
                                <div>
                                    <div
                                        className="w-[70px] h-[70px] bg-white rounded-full flex justify-center items-center relative dark:bg-[#232323] md:w-[60px] md:h-[60px]
                                ...
                                <div className="px-10 xl:px-5 md:pr-0">
                                    <h4
                                        className="font-normal text-2xl text-gray-50 mb-3 xl:text-xl xl:mb-1 dark:text-[#232323] md:text-lg">
                                        Free Deliver</h4>
